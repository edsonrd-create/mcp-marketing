...
**Generated:** 2026-08-04T01:19:30.659Z
**Expected tools:** 71
**Calls recorded:** 73
...
| `@mcp-marketing/whatsapp` | `send_birthday_message` | PASS | 3 | { "tool": "send_birthday_message", "messageId": "stub_1785806369833", "to": "+5511999999999", "status": "sent", "body": "Feliz aniversário, Smoke User! 🎂 Use o cupom SMOKE10 na sua próxima compra.",  |
| `@mcp-marketing/whatsapp` | `send_birthday` | PASS | 1 | { "tool": "send_birthday", "messageId": "stub_1785806369835", "to": "+5511999999999", "status": "sent", "body": "Feliz aniversário, Smoke User! 🎂 Use o cupom SMOKE10 na sua próxima compra.", "sentAt" |
| `@mcp-marketing/whatsapp` | `send_coupon` | PASS | 1 | { "tool": "send_coupon", "messageId": "stub_1785806369835", "to": "+5511999999999", "status": "sent", "body": "🎁 Cupom exclusivo: SAVE20 — 20% OFF.", "sentAt": "2026-08-04T01:19:29.835Z" } |
| `@mcp-marketing/whatsapp` | `send_campaign` | PASS | 0 | { "tool": "send_campaign", "campaignId": "camp-smoke", "messageId": "stub_1785806369836", "to": "+5511999999999", "status": "sent", "body": "[camp-smoke] Smoke campaign message", "sentAt": "2026-08-04 |
| `@mcp-marketing/whatsapp` | `send_template` | PASS | 1 | { "tool": "send_template", "templateName": "hello_world", "messageId": "stub_1785806369837", "to": "+5511999999999", "status": "sent", "body": "template:hello_world", "sentAt": "2026-08-04T01:19:29.83 |
| `@mcp-marketing/whatsapp` | `schedule_message` | PASS | 1 | { "tool": "schedule_message", "scheduled": { "id": "6e1e34d2-41fe-449d-9293-a88dad97a99a", "channel": "whatsapp", "recipient": "+5511999999999", "body": "Scheduled smoke message", "scheduledAt": "2026 |
| `@mcp-marketing/whatsapp` | `order_confirmation` | PASS | 1 | { "tool": "order_confirmation", "orderId": "ORD-SMOKE-1", "messageId": "stub_1785806369839", "to": "+5511999999999", "status": "sent", "body": "✅ Pedido ORD-SMOKE-1 confirmado! Total: R$ 99,90.\nItens |
...
| `@mcp-marketing/insights` | `analyze_insights` | PASS | 5 | { "tool": "analyze_insights", "count": 2, "insights": [ { "id": "d2d3356e-5623-4174-981e-216c183ad779", "severity": "info", "category": "profitability", "title": "Strong ROAS performance", "descriptio |
...
| `@mcp-marketing/insights` | `list_timeline_events` | PASS | 2 | { "tool": "list_timeline_events", "events": [ { "id": "d29a478a-fa54-4bdc-acd8-1bfb214cf62e", "type": "smoke_test", "title": "MCP tools smoke", "description": "Generated by npm run mcp:tools", "campai |
| `@mcp-marketing/insights` | `record_timeline_event` | PASS | 1 | { "tool": "record_timeline_event", "event": { "id": "68a72032-35b8-4cf0-9386-42a0bbab8621", "type": "smoke_test", "title": "MCP tools smoke", "description": "Generated by npm run mcp:tools", "campaign |
| `@mcp-marketing/insights` | `get_health_center` | PASS | 1 | { "tool": "get_health_center", "healthCenter": { "overallScore": 0, "gradeDistribution": { "A": 0, "B": 0, "C": 0, "D": 0, "F": 0 }, "campaigns": [], "alerts": [], "updatedAt": "2026-08-04T01:19:30.04 |
| `@mcp-marketing/insights` | `generate_report` | PASS | 1 | { "tool": "generate_report", "report": { "title": "Marketing Brain Insights Report", "generatedAt": "2026-08-04T01:19:30.045Z", "dashboard": { "summary": { "campaigns": 0, "totalSpend": 0, "totalReven |
| `@mcp-marketing/ai-agent` | `chat` | PASS | 4 | { "tool": "chat", "message": { "id": "84a9b210-84b9-4b65-a5b3-03674e5a3c4b", "role": "assistant", "content": "Hello! I'm the Marketing Brain agent. I can help with campaigns, budgets, reports, and wor |
| `@mcp-marketing/ai-agent` | `chat` | PASS | 1 | { "tool": "chat", "message": { "id": "fbb57d6f-bdf0-48f6-9082-a33560bfe0af", "role": "assistant", "content": "I can pause the campaign. Please confirm to proceed.", "timestamp": "2026-08-04T01:19:30.2 |
| `@mcp-marketing/ai-agent` | `list_pending_approvals` | PASS | 1 | { "tool": "list_pending_approvals", "pending": [ { "id": "2c94704d-3aaa-4e6e-b3b6-2f030cd7df92", "type": "pause_campaign", "description": "I can pause the campaign. Please confirm to proceed.", "paylo |
| `@mcp-marketing/ai-agent` | `get_agent_history` | PASS | 1 | { "tool": "get_agent_history", "history": [ { "id": "7bd188be-1167-44d1-bdde-cb572b57ef94", "role": "user", "content": "hello", "timestamp": "2026-08-03T23:15:21.259Z", "sessionId": "smoke-session" }, |
| `@mcp-marketing/ai-agent` | `get_ai_summary` | PASS | 1 | { "tool": "get_ai_summary", "summary": { "totalMessages": 38, "pendingApprovals": 1, "confirmedActions": 5, "cancelledActions": 5, "recentTopics": [ "please pause campaign Brand Awareness", "What is m |
| `@mcp-marketing/ai-agent` | `list_audit_logs` | PASS | 1 | { "tool": "list_audit_logs", "logs": [ { "id": "e78b83a0-fc28-48c7-9aec-7fbddda998a9", "action": "action_cancelled", "actor": "user", "details": { "actionId": "3ebc67fb-927a-4aaf-8b2f-61b3388e77d7", " |
| `@mcp-marketing/ai-agent` | `analyze_campaigns` | PASS | 1 | { "tool": "analyze_campaigns", "campaignCount": 2, "recommendations": [ { "id": "e05e2c2c-c905-4dc6-b6cd-a55e26ce59c9", "type": "budget", "priority": "low", "title": "Scale Summer Sale", "description" |
...
| `@mcp-marketing/ai-agent` | `generate_report` | PASS | 2 | { "tool": "generate_report", "report": { "title": "Marketing Brain Agent Report", "generatedAt": "2026-08-04T01:19:30.264Z", "summary": { "campaignCount": 2, "totalSpend": 7000, "totalRevenue": 18800, |
...
| `@mcp-marketing/ai-agent` | `suggest_actions` | PASS | 1 | { "tool": "suggest_actions", "count": 3, "actions": [ { "id": "d6bb3720-2ea6-4731-a00b-9ad9993229bb", "type": "budget", "priority": "high", "title": "Pause or restructure Retargeting", "description":  |
...
| `@mcp-marketing/ai-agent` | `marketing_chat` | PASS | 1 | { "tool": "marketing_chat", "message": { "id": "58dd7f68-b0b7-4107-bdf8-f13901c8dcfa", "role": "assistant", "content": "I understand your request. For detailed analytics, use the Insights MCP tools. F |
| `@mcp-marketing/ai-agent` | `confirm_action` | PASS | 1 | { "tool": "confirm_action", "action": { "id": "2c94704d-3aaa-4e6e-b3b6-2f030cd7df92", "type": "pause_campaign", "description": "I can pause the campaign. Please confirm to proceed.", "payload": { "ori |
| `@mcp-marketing/ai-agent` | `chat` | PASS | 2 | { "tool": "chat", "message": { "id": "bdc137b4-b4f6-4406-a1c7-f855c944d078", "role": "assistant", "content": "I can help launch a campaign. This action requires approval before execution.", "timestamp |
| `@mcp-marketing/ai-agent` | `cancel_action` | PASS | 2 | { "tool": "cancel_action", "action": { "id": "c1f47b5f-4b97-4c4b-b5b7-ca9ff651d0ad", "type": "launch_campaign", "description": "I can help launch a campaign. This action requires approval before execu |
...
| `@mcp-marketing/workflows` | `create_workflow` | PASS | 3 | { "tool": "create_workflow", "workflow": { "id": "55da159c-13c7-4c00-acfb-0e6338803386", "name": "Smoke Workflow", "description": "Created by mcp:tools", "status": "active", "trigger": { "type": "manu |
...
| `@mcp-marketing/workflows` | `create_workflow_from_template` | PASS | 1 | { "tool": "create_workflow_from_template", "workflow": { "id": "b2ac1cbb-3d1b-453c-acef-80bb146021a4", "name": "Birthday Smoke", "description": "Send a birthday WhatsApp message with optional coupon", |
...
| `@mcp-marketing/workflows` | `list_workflow_audit_logs` | PASS | 1 | { "tool": "list_workflow_audit_logs", "logs": [ { "id": "6f248ab8-9653-4999-959a-5691b12bed03", "workflowId": "511909f2-ddd2-47ca-a65d-45d7497ca139", "action": "workflow_updated", "actor": "system", " |
| `@mcp-marketing/workflows` | `update_workflow` | PASS | 2 | { "tool": "update_workflow", "workflow": { "id": "55da159c-13c7-4c00-acfb-0e6338803386", "name": "Smoke Workflow Updated", "description": "Created by mcp:tools", "status": "active", "trigger": { "type |
| `@mcp-marketing/workflows` | `duplicate_workflow` | PASS | 1 | { "tool": "duplicate_workflow", "workflow": { "id": "2e270ef6-47ea-4fa1-89da-2b2441a6e863", "name": "Smoke Workflow Updated (copy)", "description": "Created by mcp:tools", "status": "draft", "trigger" |
| `@mcp-marketing/workflows` | `run_workflow` | PASS | 1 | { "tool": "run_workflow", "execution": { "id": "90d3ca20-1db2-45ed-b6b8-e59a2e2eee43", "workflowId": "55da159c-13c7-4c00-acfb-0e6338803386", "status": "completed", "startedAt": "2026-08-04T01:19:30.62 |
| `@mcp-marketing/workflows` | `execute_workflow` | PASS | 2 | { "tool": "execute_workflow", "execution": { "id": "2179cb04-0622-4c6c-84f9-ce9cbcc399d8", "workflowId": "55da159c-13c7-4c00-acfb-0e6338803386", "status": "completed", "startedAt": "2026-08-04T01:19:3 |
| `@mcp-marketing/workflows` | `pause_workflow` | PASS | 1 | { "tool": "pause_workflow", "workflow": { "id": "55da159c-13c7-4c00-acfb-0e6338803386", "name": "Smoke Workflow Updated", "description": "Created by mcp:tools", "status": "paused", "trigger": { "type" |
| `@mcp-marketing/workflows` | `resume_workflow` | PASS | 1 | { "tool": "resume_workflow", "workflow": { "id": "55da159c-13c7-4c00-acfb-0e6338803386", "name": "Smoke Workflow Updated", "description": "Created by mcp:tools", "status": "active", "trigger": { "type |
| `@mcp-marketing/workflows` | `recover_workflow_execution` | PASS | 1 | error: Execution not found: nonexistent-execution |
| `@mcp-marketing/workflows` | `delete_workflow` | PASS | 1 | { "tool": "delete_workflow", "deleted": true, "workflowId": "55da159c-13c7-4c00-acfb-0e6338803386" } |
